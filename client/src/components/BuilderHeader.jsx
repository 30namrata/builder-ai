import { ArrowLeftIcon, ExternalLinkIcon, EyeIcon, GlobeIcon, Loader2Icon, Code2Icon, DownloadIcon } from "lucide-react";
        ...
        <header className="h-12 shrink-0 flex items-center justify-between px-3 border-b border-zinc-200 bg-white">
            ...
            <div className="flex items-center gap-1.5">
                ...
                <button
                    onClick={onPublish}
                    disabled={publishing}
                    className="inline-flex items-center justify-center gap-1.5 py-1.5 px-3 border border-zinc-200 text-zinc-600 hover:bg-zinc-100 hover:text-zinc-900 text-xs font-medium rounded-lg cursor-pointer bg-white disabled:opacity-50 disabled:cursor-not-allowed"
                >
                    {publishing ? (
